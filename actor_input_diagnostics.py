...
from actor_input_agent import sample_residual, actor_input
...
def probe(agent, batch, key):
    ...
    u, logp, _ = sample_residual(agent.actor.apply_fn, agent.actor.params, actor_input(batch['next_observations'], batch['next_base_actions'], agent.condition_on_base), nk)
    ...
    cu, _, _ = sample_residual(agent.actor.apply_fn, agent.actor.params, actor_input(batch['observations'], batch['base_actions'], agent.condition_on_base), ak)

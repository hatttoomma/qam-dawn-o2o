...
parser.add_argument('--output', default='/Users/riverwang/Documents/ICRA2026/output/antmaze_large_online60_utd00625_20260914/remote_status.json')
args = parser.parse_args()
source = '''
from pathlib import Path
import json,os,subprocess,time,hashlib,gzip,base64
root=Path('/root/autodl-tmp/qam_antmaze_online60_utd00625')

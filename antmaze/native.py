...
class AgentFactory:
    ...
    def create(seed, obs, action, cfg):
        ...
        write('actual_agent_config.json', dict(agent_config=dict(agent.config), modules=names,
            ...
            seed=seed, vanilla_QAM=True, source_commit='2726d767c9a0a7a46d49693f0391f73dc2cf58ac'))
        return agent
...
if __name__ == '__main__':
    sys.argv = [sys.argv[0], '--agent=agents/qam.py', '--seed=0', f'--env_name={ENV}',
        '--tags=QAM', '--run_group=antmaze_task1_500k_50k', f'--save_dir={OUT / "official_logs"}',

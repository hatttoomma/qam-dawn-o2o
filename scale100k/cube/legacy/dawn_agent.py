"""DAWN-style residual SAC on the exact QAM critic backbone."""
...
class DawnAgent:
    ...
    def create(cls, qam, obs, seed, warm):
        ...
        actor = TrainState.create(apply_fn=adef.apply, params=adef.init(akey, obs)['params'], tx=tx)
    ...
    def sample(self, obs, base, key, deterministic=False):
        u, logp, _ = sample_residual(self.actor.apply_fn, self.actor.params, obs, key, deterministic)
